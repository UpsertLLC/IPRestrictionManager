                ...
                'panels' => [
                    ...
                    1 => [
                        ...
                        'fields' => [
                            ...
                            [
                                'name' => 'upsert_IPRestrictionManager_allow_support_access',
                                'label' => 'LBL_UPSERT_IPRESTRICTIONMANAGER_ALLOW_SUPPORT_ACCESS',
                                'enabled' => true,
                                'view' => 'edit',
                                'type' => 'enum',
                                'default' => 'Enabled',
                                'required' => false,
                                'options' => 'upsert_iprestrictionmanager_allow_support_access_list',
                                'source' => 'non-db',
                                'help' => 'LBL_UPSERT_IPRESTRICTIONMANAGER_ALLOW_SUPPORT_ACCESS_HELP',
                                'span' => 8,
                            ],
                            [
                                'name' => 'upsert_IPRestrictionManager_global_ips',
                                'label' => 'LBL_UPSERT_IPRESTRICTIONMANAGER_GLOBAL_IPS',
                                'enabled' => true,
                                'view' => 'edit',
                                'type' => 'upsert-list-collection',
                                'required' => false,
                                'source' => 'non-db',
                                'help' => 'LBL_UPSERT_IPRESTRICTIONMANAGER_GLOBAL_IPS_HELP',
                                'span' => 8,
                                'default' => '["54.153.90.191\/32","54.153.90.96\/32"]',
